...
use Archer\MeetEntryBundle\Entity\Competition;
use Archer\MeetEntryBundle\Form\CompetitionType;
...
class CompetitionController extends Controller
{
     ...
     *
     * @Route("/createfancy", name="competition_create_fancy")
     * @Method("GET")
     * @Template("ArcherMeetEntryBundle:Competition:fancy_create.html.twig")
     */
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ArcherMeetEntryBundle:Competition')->findAll();
     ...
     * @Method("POST")
     * @Template("ArcherMeetEntryBundle:Competition:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ArcherMeetEntryBundle:Competition')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ArcherMeetEntryBundle:Competition:edit.html.twig")
     */
